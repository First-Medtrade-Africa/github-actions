...
class Application
{
    ...
    public function AccountApprovalEmail($name, $email){
            $mail = new PHPMailer(true);
            $mail->isSMTP();
            // $mail->SMTPDebug  = SMTP::DEBUG_SERVER;
            $mail->Host = 'mail.firstmedtradeafrica.com';
            ...
            $mail->setFrom('admin@firstmedtradeafrica.com','Amina');
            $mail->addAddress($email);
            $mail->Subject = 'Welcome To First MedTrade Africa';
                          ...
                          <tr>
                            <td style="border-collapse:collapse">
                              <table border="0" cellpadding="0" cellspacing="0" style="border:none;border-collapse:collapse" width="600" align="center">
                                <tbody>
                                  <tr>
                                    <td align="left" style="border-collapse:collapse;color:#001973;font-family:helvetica,arial,sans-serif;font-size:30px;font-weight:100;line-height:32px;padding:0 0 10px 0">Welcome To First medTrade Africa.</td> 
                                  </tr>
                                </tbody>
                              </table>
                            </td>
                                ...
                                <tbody>
                                  <tr>
                                    <td style=" border-collapse:collapse; color:#333333; font-family:helvetica,arial,sans-serif; font-size:17px; line-height:24px; font-weight:100; padding:0 30px 38px 0" align="left">
                                        ...
                                        Thank you for registering on Africa"s foremost online medical market. Your seller account Under Review Has been Approved.<br>
                                        you can now add products and begin selling.<br>
                                        <br>

                                        Best regards,<br>

                                        Team First Medtrade.<br>
                                    </td>
                                  </tr>
                                </tbody>
                              </table>
    ...
    public function ConfirmPaymentEmail($name, $email){
            $mail = new PHPMailer(true);
            $mail->isSMTP();
            // $mail->SMTPDebug  = SMTP::DEBUG_SERVER;
            $mail->Host = 'mail.firstmedtradeafrica.com';
            ...
            $mail->setFrom('admin@firstmedtradeafrica.com','Amina');
            $mail->addAddress($email);
            $mail->Subject = 'Confirmed Payment';
                          ...
                          <tr>
                            <td style="border-collapse:collapse">
                              <table border="0" cellpadding="0" cellspacing="0" style="border:none;border-collapse:collapse" width="600" align="center">
                                <tbody>
                                  <tr>
                                    <td align="left" style="border-collapse:collapse;color:#001973;font-family:helvetica,arial,sans-serif;font-size:30px;font-weight:100;line-height:32px;padding:0 0 10px 0">Payment Confirmed</td> 
                                  </tr>
                                </tbody>
                              </table>
                            </td>
                                ...
                                <tbody>
                                  <tr>
                                    <td style=" border-collapse:collapse; color:#333333; font-family:helvetica,arial,sans-serif; font-size:17px; line-height:24px; font-weight:100; padding:0 30px 38px 0" align="left">
                                        ...
                                        Thank you for Using First Medtrade on Africa"s foremost online medical market. Your Payment Has been Confirmed.<br>
    ...
    public function ManConfirmPaymentEmail($name, $email){
            $mail = new PHPMailer(true);
            $mail->isSMTP();
            // $mail->SMTPDebug  = SMTP::DEBUG_SERVER;
            $mail->Host = 'mail.firstmedtradeafrica.com';
